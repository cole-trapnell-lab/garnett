...
test_that("whole process is the same", {
  ...
  expect_equal(sum(pData(test_cds)$cell_type == "T cells"), 116)
  expect_equal(sum(pData(test_cds)$cluster_ext_type == "B cells"), 399)
  expect_equal(sum(pData(test_cds)$cluster_ext_type == "CD4 T cells"), 270)
  expect_equal(sum(pData(test_cds)$cluster_ext_type == "T cells"), 131)
})
...
test_that("whole process is the same db = 'none'", {
  ...
  expect_equal(sum(pData(test_cds)$cluster_ext_type == "T cells"), 401)
})
