...
test_that("whole process is the same", {
  expect_equal(sum(pData(test_cds)$cell_type == "B cells"), 207)
  expect_equal(sum(pData(test_cds)$cell_type == "CD4 T cells"), 129)
  expect_equal(sum(pData(test_cds)$cell_type == "CD8 T cells"), 61)
  expect_equal(sum(pData(test_cds)$cell_type == "T cells"), 164)
