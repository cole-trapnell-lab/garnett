...
test_that("classify_cells marker_free works", {
  ...
  expect_equal(sum(colData(new_cds)$cell_type == "CD8 T cells"), 112)
...
test_that("classify_cells marker_free mixed works", {
  expect_identical(counts(new_cds), counts(test_cds))
  expect_identical(rowData(new_cds), rowData(test_cds))
  expect_equal(sum(colData(new_cds)$cell_type == "B cells"), 190)
  expect_equal(sum(colData(new_cds)$cell_type == "CD4 T cells"), 24)
  expect_equal(sum(colData(new_cds)$cell_type == "CD8 T cells"), 92)
  expect_equal(sum(colData(new_cds)$cell_type == "T cells"), 283)
  expect_equal(sum(colData(new_cds)$cluster_ext_type == "B cells"), 401)
  expect_equal(sum(colData(new_cds)$cluster_ext_type == "CD4 T cells"), 203)
  expect_equal(sum(colData(new_cds)$cluster_ext_type == "T cells"), 44)
})
